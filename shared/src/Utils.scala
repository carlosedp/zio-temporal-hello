...
extension [R, E, A](z: ZIO[R, E, A]) {
  ...
  /** Measure the execution time for the wrapped effect. Returns a tuple containing the effect result, time in
    * milisseconds and description.
    * {{{
    *   for
    ...
    * @return
    *   a tuple containing the effect result, the execution time in milisseconds and the description.
    */
  ...
  /** Measure the execution time for the wrapped effect printing the output to console.
    *
    * @param description
